...
public enum AccErrorMessage implements BaseErrorMessage {
    ...
    FIELD_CANNOT_BE_NULL("Field cannot be null","Some of the fields are null, please be sure to enter all fields"),
    BALANCE_CANNOT_BE_NEGATIVE("Balance cannot assigned negative","Please be sure that you entered a balance that is not negative"),
    AMOUNT_MUST_BE_POSITIVE("Amount must be positive","Please be sure that the entered amount value is larger than zero"),
    ;
